 ...
 */
public class Home_Motivation extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_display_motivation, container, false);

        mot1 = (TextView) v.findViewById(R.id.motivation1);
        mot2 = (TextView) v.findViewById(R.id.motivation1);
        mot3 = (TextView) v.findViewById(R.id.motivation1);
        ...
        if (habit != null) {
            try {
                ...
                if (habit.get("mot1") != null){
                    mot1.setText((String) habit.get("mot1"));
                }

                if (habit.get("mot2") != null){
                    mot2.setText((String) habit.get("mot2"));
                }


                if (habit.get("mot3") != null){
                    mot3.setText((String) habit.get("mot3"));
                }
