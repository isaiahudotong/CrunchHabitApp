...
public class Cue_When extends Fragment implements ReminderDialog.ReminderDialogListener {
...
@Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_when, container, false);
        ...
        mNextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (etWhen.getEditableText() == null || etWhen.getEditableText().toString().equals("")) {

                    Toast.makeText(getActivity(), "Oops! You didn't enter your habit information", Toast.LENGTH_SHORT).show();

                } else {

                    IndividualHabit individualHabit = ((NewIndividualHabitActivity) mActivity).getIndividualHabit();

                    individualHabit.setBadWhenTrigger(etWhen.getText().toString());
                    ...
                    habit.setIndividualHabit(individualHabit);
