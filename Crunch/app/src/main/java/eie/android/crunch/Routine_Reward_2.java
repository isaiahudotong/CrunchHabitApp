 ...
 */
public class Routine_Reward_2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        reward = (EditText) v.findViewById(R.id.reward_desc);
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Reward reward2 = ((NewIndividualHabitActivity) mActivity).getReward();

                IndividualHabit habit = ((NewIndividualHabitActivity) mActivity)
                        .getIndividualHabit();


                habit.setBadWhenTrigger(reward.getText().toString());
                ...
                Routine_Reward_2 fm2 = new Routine_Reward_2();
