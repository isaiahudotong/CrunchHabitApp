 ...
 */
public class HabitsLearningAdapter extends RecyclerView.Adapter<HabitsLearningAdapter.ViewHolder> {

    private ParseQueryAdapter<ParseObject> parseAdapter;

    private ViewGroup parseParent;

    private HabitsLearningAdapter habitsAdapter = this;
    private ToggleButton mToggleButton;
    private TextView mTextView;
    private int likes = 115;
    private int counter = likes + 1;
    private Activity mActivity;
    
    public HabitsLearningAdapter(final Context context, ViewGroup parentIn) {
        ...
        parseAdapter = new ParseQueryAdapter<ParseObject>(context,
                new ParseQueryAdapter.QueryFactory<ParseObject>() {
                    public ParseQuery<ParseObject> create() {
                        ...
                        query.whereEqualTo("good_tag", "learning");
                        return query;
                    }}) {
            ...
            public View getItemView(ParseObject object, View v, ViewGroup parent) {
                if (v == null) {
                    v = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_each_book,
                            parent, false);
                }
...
//                                goodHabit.put("likes", rand.nextInt(50));
                ...
                mTextView = (TextView) v.findViewById(R.id.list_item_habit_likes_learning);
                mToggleButton = (ToggleButton) v.findViewById(R.id.toggle_learning);
                mToggleButton.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if (on) {
                            ...
                            TextView mTextView = (TextView) viewGroup.findViewById(R.id.list_item_habit_likes_learning);
                            int counter = likes + 1;
    ...
    @Override
    public HabitsLearningAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.list_each_book, parent, false);
