 ...
 */
public class HabitsLifestyleAdapter extends RecyclerView.Adapter<HabitsLifestyleAdapter.ViewHolder> {

    private ParseQueryAdapter<ParseObject> parseAdapter;

    private ViewGroup parseParent;

    private HabitsLifestyleAdapter habitsAdapter = this;
...
//    Random rand = new Random();
    ...
    public HabitsLifestyleAdapter(Context context, ViewGroup parentIn) {
        ...
        parseAdapter = new ParseQueryAdapter<ParseObject>(context,
                new ParseQueryAdapter.QueryFactory<ParseObject>() {
                    public ParseQuery<ParseObject> create() {
                        ...
                        query.whereEqualTo("good_tag", "lifestyle");
                        return query;
                    }
                }) {
...
//                                goodHabit.put("likes", rand.nextInt(50));
    ...
    @Override
    public HabitsLifestyleAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
