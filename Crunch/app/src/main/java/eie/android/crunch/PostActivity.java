...
public class PostActivity extends Activity {
    ...
    private int maxCharacterCount = CrunchApplication.getConfigHelper().getPostMaxCharacterCount();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Location location = intent.getParcelableExtra(CrunchApplication.INTENT_EXTRA_LOCATION);
